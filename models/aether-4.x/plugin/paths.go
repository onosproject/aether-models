...
import (
	...
	"fmt"
	"encoding/json"
    "github.com/onosproject/config-models/models/aether-4.x-4.0.18/api"
...
func ExtractPaths() ([]*admin.ReadOnlyPath, []*admin.ReadWritePath) {
	...
	roPathMap, rwPathMap = extractPaths(entries[rootPath], yang.TSUnset, "", "")
