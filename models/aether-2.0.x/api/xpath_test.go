	...
	tests := []navigator.XpathSelect{
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/@ent:application-id",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/ent:address",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/ent:endpoint",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/ent:endpoint/@ent:endpoint-id",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/ent:endpoint[@ent:endpoint-id='da1']/ent:port-start",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/ent:endpoint[@ent:endpoint-id='da2']/ent:port-end",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:application[@ent:application-id='acme-dataacquisition']/ent:endpoint[@ent:endpoint-id='da2']/ent:mbr/ent:downlink",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:site[@ent:site-id='starbucks-newyork']/ent:slice[@ent:slice-id='starbucks-newyork-cameras']/@ent:slice-id",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:site[@ent:site-id='starbucks-newyork']/ent:slice[@ent:slice-id='starbucks-newyork-cameras']/ent:device-group[@ent:device-group='starbucks-newyork-cameras-front']/@ent:device-group",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:site[@ent:site-id='starbucks-newyork']/ent:device-group[@ent:device-group-id='starbucks-newyork-cameras-front']/@ent:device-group-id",
			Expected: []string{
		...
		{
			Name:  "test slice starbucks-newyork-cameras dg starbucks-newyork-cameras-front enable",
			XPath: "/ent:enterprises/ent:enterprise/ent:site[@ent:site-id='starbucks-newyork']/ent:device-group[@ent:device-group-id='starbucks-newyork-cameras-front']/ent:ip-domain",
			Expected: []string{
		...
		},
		{
			...
			XPath: "/ent:enterprises/ent:enterprise/ent:site[@ent:site-id='starbucks-newyork']/ent:ip-domain[@ent:ip-domain-id=../ent:device-group[@ent:device-group-id='starbucks-newyork-pos']/ent:ip-domain]/@ent:ip-domain-id",
			Expected: []string{
		...
		},
		{
			...
			XPath: "ent:device-group[set-contains(../ent:slice/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/@ent:device-group-id",
			Expected: []string{
		...
		},
		{
			...
			XPath:    "./ent:slice[set-contains(following-sibling::ent:slice/ent:device-group/@ent:device-group, ent:device-group/@ent:device-group)]/@ent:slice-id",
			Expected: []string{},
		},
	}
...
func Test_XPathSelectSite(t *testing.T) {
	...
	tests := []navigator.XpathSelect{
		{
			...
			XPath: "./ent:device-group[@ent:device-group-id='acme-dallas-default']/ent:ip-domain",
			Expected: []string{
		...
		},
		{
			...
			XPath: "./ent:ip-domain[@ent:ip-domain-id='acme-chicago']/@ent:ip-domain-id",
			Expected: []string{
		...
		},
		{
			...
			XPath: "./ent:device-group[@ent:device-group-id='acme-chicago-default']/ent:ip-domain",
			Expected: []string{
		...
		},
		{
			...
			XPath: "./ent:ip-domain[@ent:ip-domain-id=../ent:device-group[@ent:device-group-id='acme-dallas-default']/ent:ip-domain]/ent:dnn",
			Expected: []string{
		...
		},
		{
			...
			XPath: "./ent:device-group/ent:ip-domain",
			Expected: []string{
				"Iter Value: ip-domain: acme-chicago",
		...
		},
		{
			...
			XPath: "./ent:device-group[@ent:device-group-id='acme-dallas-default']/following-sibling::node()",
			Expected: []string{
		...
		},
		{
			...
			XPath: "./ent:device-group[set-contains(following-sibling::ent:device-group/ent:ip-domain, ent:ip-domain)]/ent:ip-domain",
			Expected: []string{
				"Iter Value: ip-domain: acme-chicago",
				"Iter Value: ip-domain: acme-dallas",
			},
		},
		{
			...
			XPath: "./ent:ip-domain[set-contains(following-sibling::ent:ip-domain/ent:dnn, ent:dnn)]/ent:dnn",
			Expected: []string{
				"Iter Value: dnn: dnndallas",
			},
		},
		{
			...
			XPath: "ent:ip-domain[set-contains(../ent:device-group/ent:ip-domain, @ent:ip-domain-id)]/ent:dnn",
			Expected: []string{
		...
		},
		{
			...
			XPath: "ent:device-group[set-contains(../ent:slice/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/ent:ip-domain",
			Expected: []string{
				"Iter Value: ip-domain: acme-chicago",
				"Iter Value: ip-domain: acme-chicago",
				"Iter Value: ip-domain: acme-dallas",
		...
		},
		{
			...
			XPath: "ent:ip-domain[set-contains(../ent:device-group[set-contains(../ent:slice/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/ent:ip-domain, @ent:ip-domain-id)]/ent:dnn",
			Expected: []string{
				"Iter Value: dnn: dnnacme",
				"Iter Value: dnn: dnndallas",
			},
		},
		{
			...
			XPath:    "ent:ip-domain[set-contains(../ent:device-group[set-contains(../ent:slice[set-contains(following-sibling::ent:slice/@ent:slice-id, @ent:slice-id)]/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/ent:ip-domain, @ent:ip-domain-id)]/ent:dnn",
			Expected: []string{
				//"Iter Value: dnn: dnnacme",
				//"Iter Value: dnn: dnndallas",
			},
		},
		{
			...
			XPath: "ent:ip-domain[set-contains(../ent:device-group[set-contains(../ent:slice[@ent:slice-id='acme-chicago-robots']/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/ent:ip-domain, @ent:ip-domain-id)]/ent:dnn",
			Expected: []string{
				"Iter Value: dnn: dnnacme",
			},
		},
		{
			...
			XPath: "ent:slice[@ent:slice-id='acme-chicago-robots']/ent:device-group/@ent:device-group",
			Expected: []string{
		...
		},
		{
			...
			XPath: "ent:slice[@ent:slice-id='acme-dallas-robots']/ent:device-group/@ent:device-group",
			Expected: []string{
				"Iter Value: device-group: acme-dallas-extra",
	...
	for _, test := range tests {
		...
		ynn.NavigateTo("/enterprises/enterprise[enterprise-id=acme]/site[site-id=acme-chicago]")
...
func Test_XPathEvaluateDeviceGroup(t *testing.T) {
		...
		*/
		{
			...
			XPath:    "count(../ent:device-group[ent:ip-domain='acme-houston']) <= 1",
			Expected: true,
		},
		{
			Name:     "see that string of set of DG gives only first one",
			XPath:    "string(//ent:device-group/ent:ip-domain)",
			Expected: "acme-chicago",
		},
		{
			Name:     "see that ipdomain is not reused by device-group",
			XPath:    "boolean(../ent:device-group[set-contains(following-sibling::ent:device-group/ent:ip-domain, ent:ip-domain)])",
		...
		},
		{
			...
			XPath:    "count(../ent:slice[set-contains(following-sibling::ent:slice/ent:device-group/@ent:device-group, ent:device-group/@ent:device-group)]/@ent:slice-id)",
	...
	for _, test := range tests {
		...
		ynn.NavigateTo("/enterprises/enterprise[enterprise-id=acme]/site[site-id=acme-chicago]/device-group[device-group-id=acme-dallas-bis]")
	...
	tests := []navigator.XpathEvaluate{
		{
			...
			XPath:    "count(ent:ip-domain)",
			Expected: float64(4),
		},
		{
			Name:     "test count device-group",
			XPath:    "count(ent:device-group)",
			Expected: float64(5),
		},
		{
			Name:     "test count device-group whose following node has same ip-domain",
			XPath:    "count(ent:device-group[ent:ip-domain=following::ent:device-group/ent:ip-domain])",
			Expected: float64(2),
		},
		{
			Name:     "count of DNNs used in all the slices in this site",
			XPath:    "count(ent:ip-domain[set-contains(../ent:device-group[set-contains(../ent:slice/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/ent:ip-domain, @ent:ip-domain-id)]/ent:dnn)",
			Expected: float64(2),
		},
		{
			Name:     "count of device-groups used in the slices in this site",
			XPath:    "count(ent:device-group[set-contains(../ent:slice/ent:device-group/@ent:device-group, ./@ent:device-group-id)]/@ent:device-group-id)",
			Expected: float64(3),
		},
		{
